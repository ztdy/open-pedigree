...
module.exports = {
  ...
  people: {
    ...
    'II-9': { sex: 'F', presymptomatic: true, gene: G, note: 'Unaffected carrier; prophylactic bilateral mastectomy + BSO at 40; no cancer.' },
    ...
    'III-8':  { sex: 'M', presymptomatic: true, gene: G, note: 'Unaffected male carrier — proves autosomal transmission (II-3 → III-8, father to son). PSA surveillance.' },
    'III-9':  { sex: 'F', note: 'Married in.' },
    'III-10': { sex: 'F', presymptomatic: true, gene: G, note: 'Unaffected carrier; prophylactic bilateral mastectomy at 36.' },
    'III-11': { sex: 'M', note: 'Married in.' },
    'III-12': { sex: 'M', presymptomatic: true, gene: G, note: 'Unaffected male carrier; active surveillance.' },
    ...
    'IV-2':  { sex: 'M', presymptomatic: true, gene: G, note: 'Unaffected male carrier; screening and counseling.' },
    'IV-3':  { sex: 'F', note: 'Tested non-carrier.' },
    'IV-4':  { sex: 'F', presymptomatic: true, gene: G, note: 'Unaffected carrier; enhanced MRI surveillance.' },
    ...
    'IV-7':  { sex: 'M', presymptomatic: true, gene: G, note: 'Unaffected male carrier.' },
    'IV-8':  { sex: 'F', note: 'At-risk minor, untested.' },
    'IV-9':  { sex: 'M', note: 'At-risk minor, untested.' },
    'IV-10': { sex: 'F', presymptomatic: true, gene: G, note: 'Unaffected carrier; surveillance.' },
