...
var Disorder = Class.create( {
  ...
  load: function(callWhenReady) {
    // Desktop build: no OMIM database is bundled (licensing). Don't fire a doomed XHR (the
    // legacy Suggest/loader surfaces failures as blocking alerts offline); fall back to the
    // id-derived name so the term shows something instead of a stuck "loading...".
